 ...
 */
export function generateSystemPrompt(titleAnalysis?: TitleAnalysis): string {
 ...
 */
export function generateUserPrompt(content: string, title?: string, titleAnalysis?: TitleAnalysis): string {
  let instruction = "";
