...
exports.runStagingPipeline = runStagingPipeline;
...
const to_staging_1 = require("./upsert/to_staging");
const logger_1 = require("../core/logger");
const metrics_1 = require("../core/metrics");
/**
 * Run ETL pipeline to staging table (for review)
 */
async function runStagingPipeline(config) {
    ...
    try {
        ...
        const supabase = (0, supabase_1.getSupabaseClient)(config.database);
        ...
        for (const article of newArticles) {
            ...
            try {
                ...
                // Step 3: Normalize
                const normalized = (0, normalize_1.normalizeSneakers)(extractResult.sneakers);
        ...
        if (totalNewItems > 0 && !config.dryRun) {
            ...
            await (0, to_staging_1.notifyNewStagingItems)(totalNewItems);
        }
        // Final summary
        metrics.finish();
...
//# sourceMappingURL=run-staging.js.map