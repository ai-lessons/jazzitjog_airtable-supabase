...
exports.multiModelContent = void 0;
// Тест для проверки смешивания данных между моделями в одной статье
const extractMultiModel_1 = require("../llm/extractMultiModel");
...
exports.multiModelContent = multiModelContent;
console.log('=== TESTING DATA CROSS-CONTAMINATION ===\n');
console.log('Content:');
console.log(multiModelContent);
console.log('\n');
const models = (0, extractMultiModel_1.extractMultipleModels)(multiModelContent);
...
const brooksModels = (0, extractMultiModel_1.extractMultipleModels)(brooksOnly);
...
const hokaModels = (0, extractMultiModel_1.extractMultipleModels)(hokaOnly);
...
//# sourceMappingURL=data_cross_contamination_test.js.map