...
exports.isNonSneakerItem = isNonSneakerItem;
exports.isSneakerItem = isSneakerItem;
exports.shouldIncludeInSneakerDB = shouldIncludeInSneakerDB;
 ...
 */
function isNonSneakerItem(modelName) {
 ...
 */
function isSneakerItem(modelName) {
    if (!modelName || typeof modelName !== 'string')
        return false;
    const normalized = modelName.toLowerCase().trim();
 ...
 */
function shouldIncludeInSneakerDB(brandName, modelName) {
...
//# sourceMappingURL=sneakerValidation.js.map