...
function testValidation() {
    ...
    for (const [brand, model] of nonSneakers) {
        const result = (0, sneakerValidation_1.shouldIncludeInSneakerDB)(brand, model);
    ...
    const problematic = (0, sneakerValidation_1.shouldIncludeInSneakerDB)('Ciele Athletics', 'FLRJacket-Elite');
